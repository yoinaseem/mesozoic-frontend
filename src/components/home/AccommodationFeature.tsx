      ...
      <div className="mx-auto max-w-7xl px-6">
        <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-[minmax(0,1fr)_minmax(0,0.95fr)]">
          ...
          <div className="relative min-h-80 perspective-[1400px] lg:min-h-112">
            ...
            <div className="group/inset bg-surface absolute -bottom-6 -left-6 hidden h-40 w-56 rounded-xl p-1.5 shadow-2xl transition-transform duration-700 ease-out will-change-transform transform-[scale(1)_rotateX(0deg)_rotateY(0deg)] group-hover/inset:transform-[scale(1)_rotateX(0.8deg)_rotateY(-3deg)] group-active/inset:transform-[scale(1)_rotateX(0.8deg)_rotateY(-3deg)] lg:block">
